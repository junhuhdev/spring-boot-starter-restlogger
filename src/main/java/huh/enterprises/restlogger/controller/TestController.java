...
public class TestController {
    ...
    public ResponseEntity createUsersError() {
        var result = restTemplate.postForObject("https://jsonplaceholder.typicode.com/error", Post.builder().name("hello").build(), Object.class);
